...
def getaxialseparations_no_smoothing(relpos, max_distance=100.0, transverse_limit=10.0):
    ...
    # Select desired data.
    axpoints = relpos.axial[
        (relpos.axial < max_distance) & (relpos.transverse < transverse_limit)
    ]
    sorted_axpoints = np.sort(axpoints)
    return sorted_axpoints


def getaxialseparations_with_smoothing(
    relpos,
    fitlength=100.0,
    ...
    axpoints = relpos.axial[
        (relpos.axial < (fitlength + smoothing * 3))
...
def get_transverse_separations(relpos, max_distance=100.0, axial_limit=10.0):
    """Get axial separations between localisations, also within a limited
    transverse distance of one another.
    ...
    """
    # Select desired data.
    trans_points = relpos.transverse[
        (relpos.transverse < max_distance)
...
def fitmodel_to_hist(
    ...
    try:
        popt, pcov = curve_fit(
            model, x, experimentaldist, p0=initial_params, bounds=param_bounds
        )
    except RuntimeError:
    ...
    ssr = np.sum((model(x, *popt) - experimentaldist) ** 2)
...
def set_up_model_3_peaks_fixed_ratio_with_fit_settings():
    ...
    model_with_fit_settings = ModelWithFitSettings(
        model_rpd=linmods.linrepplusreps3fixedpeakratio
    )
    ...
    initial_params = [
        initial_params_dict["repeat_distance"],
    ...
    upper_bounds = [
        upper_bound_dict["repeat_distance"],
    ...
    model_with_fit_settings.initial_params = initial_params
    model_with_fit_settings.param_bounds = bounds
...
def set_up_model_4_peaks_fixed_ratio_with_fit_settings():
    ...
    # Generate ModelWithFitSettings object, conatining a model_rpd
    model_with_fit_settings = ModelWithFitSettings(
        model_rpd=linmods.linrepplusreps4fixedpeakratio
    )
...
def set_up_model_5_peaks_fixed_ratio_with_fit_settings():
    ...
    # Generate ModelWithFitSettings object, conatining a model_rpd
    model_with_fit_settings = ModelWithFitSettings(
        model_rpd=linmods.linrepplusreps5fixedpeakratio
    )
...
def set_up_model_5_peaks_fixed_ratio_no_replocs_with_fit_settings():
    ...
    # Generate ModelWithFitSettings object, conatining a model_rpd
    model_with_fit_settings = ModelWithFitSettings(
        model_rpd=linmods.linrepnoreps5_fixedpeakratio
    )
...
def set_up_model_5_variable_peaks_with_fit_settings():
    ...
    # Generate ModelWithFitSettings object, conatining a model_rpd
    model_with_fit_settings = ModelWithFitSettings(
        model_rpd=linmods.linrepnoreps5_bg_non_negative
    )
...
def set_up_model_5_variable_peaks_no_bg_with_fit_settings():
    ...
    # Generate ModelWithFitSettings object, conatining a model_rpd
    model_with_fit_settings = ModelWithFitSettings(
        model_rpd=linmods.linrepnoreps5_bg_zero
    )
...
def set_up_model_5_variable_peaks_bg_flat_with_fit_settings():
    ...
    # Generate ModelWithFitSettings object, conatining a model_rpd
    model_with_fit_settings = ModelWithFitSettings(
        model_rpd=linmods.linrepnoreps5_bg_flat
    )
...
def set_up_model_5_variable_peaks_with_replocs_no_bg_with_fit_settings():
    ...
    # Generate ModelWithFitSettings object, conatining a model_rpd
    model_with_fit_settings = ModelWithFitSettings(
        model_rpd=linmods.linrepplusreps5_no_bg
    )
...
def set_up_model_5_variable_peaks_with_replocs_bg_flat_with_fit_settings():
    ...
    # Generate ModelWithFitSettings object, conatining a model_rpd
    model_with_fit_settings = ModelWithFitSettings(
        model_rpd=linmods.linrepplusreps5_bg_flat
    )
...
def set_up_model_5_variable_peaks_after_offset_with_fit_settings():
    ...
    # Generate ModelWithFitSettings object, conatining a model_rpd
    model_with_fit_settings = ModelWithFitSettings(
        model_rpd=linmods.lin_repeat_after_offset_5
    )
    ...
    initial_params = [
        initial_params_dict["repeat_distance"],
        initial_params_dict["repeat_broadening"],
        10.0,  # initial_params_dict['first_peak_offset'],
        initial_params_dict["amp_peak_1"],
        initial_params_dict["amp_peak_2"],
        initial_params_dict["amp_peak_3"],
        initial_params_dict["amp_peak_4"],
...
def set_up_model_5_variable_peaks_after_offset_flat_bg_with_fit_settings():
    ...
    # Generate ModelWithFitSettings object, conatining a model_rpd
    model_with_fit_settings = ModelWithFitSettings(
        model_rpd=linmods.lin_repeat_after_offset_5_flat_bg_replocs
    )
    ...
    upper_bounds = [
        upper_bound_dict["repeat_distance"],
        upper_bound_dict["repeat_broadening"],
        10.0,  # upper_bound_dict['first_peak_offset'],
        upper_bound_dict["amp_peak_1"],
        upper_bound_dict["amp_peak_2"],
        upper_bound_dict["amp_peak_3"],
        upper_bound_dict["amp_peak_4"],
        1000.0,  # upper_bound_dict['amp_peak_5'],
        10000.0,  # upper_bound_dict['amp_peak_6'],
        upper_bound_dict["loc_prec_sd"],
        upper_bound_dict["loc_prec_amp"],
        upper_bound_dict["bg_offset"],
    ]
...
def set_up_model_4_variable_peaks_with_fit_settings():
    ...
    # Generate ModelWithFitSettings object, conatining a model_rpd
    model_with_fit_settings = ModelWithFitSettings(
        model_rpd=linmods.linrepnoreps4_bg_non_negative
    )
...
def set_up_model_4_variable_peaks_after_offset_with_fit_settings():
    ...
    # Generate ModelWithFitSettings object, conatining a model_rpd
    model_with_fit_settings = ModelWithFitSettings(
        model_rpd=linmods.lin_repeat_after_offset_4
    )
...
def set_up_model_linear_fit_with_fit_settings():
    ...
    """
    # Generate ModelWithFitSettings object, conatining a model_rpd
    model_with_fit_settings = ModelWithFitSettings(model_rpd=linmods.linear_fit)
    ...
    initial_params = [initial_params_dict["bg_slope"], initial_params_dict["bg_offset"]]

    lower_bounds = [lower_bound_dict["bg_slope"], lower_bound_dict["bg_offset"]]

    upper_bounds = [upper_bound_dict["bg_slope"], upper_bound_dict["bg_offset"]]

    bounds = (lower_bounds, upper_bounds)

    model_with_fit_settings.initial_params = initial_params
    model_with_fit_settings.param_bounds = bounds
    model_with_fit_settings.vector_input_model = linmods.linear_fit_vector_args
...
def set_up_model_linear_fit_plusreplocs_with_fit_settings():
    ...
    """
    # Generate ModelWithFitSettings object, conatining a model_rpd
    model_with_fit_settings = ModelWithFitSettings(model_rpd=linmods.justreplocs)
    ...
    model_with_fit_settings.initial_params = initial_params
    model_with_fit_settings.param_bounds = bounds
    model_with_fit_settings.vector_input_model = linmods.justreplocs_vectorinput
...
def set_up_model_onepeak_with_fit_settings():
    ...
    """
    # Generate ModelWithFitSettings object, conatining a model_rpd
    model_with_fit_settings = ModelWithFitSettings(model_rpd=linmods.onepeaknoreps)
    ...
    model_with_fit_settings.initial_params = initial_params
    model_with_fit_settings.param_bounds = bounds
    model_with_fit_settings.vector_input_model = linmods.onepeaknoreps_vectorinput
...
def set_up_model_onepeak_noreplocs_no_bg_with_fit_settings():
    ...
    """
    # Generate ModelWithFitSettings object, conatining a model_rpd
    model_with_fit_settings = ModelWithFitSettings(model_rpd=linmods.onepeaknorepsnobg)
    ...
    model_with_fit_settings.initial_params = initial_params
    model_with_fit_settings.param_bounds = bounds
    model_with_fit_settings.vector_input_model = linmods.onepeaknorepsnobg_vectorinput
...
def set_up_model_onepeak_plus_replocs_with_fit_settings():
    ...
    """
    # Generate ModelWithFitSettings object, conatining a model_rpd
    model_with_fit_settings = ModelWithFitSettings(model_rpd=linmods.onepeakplusreps)
    ...
    model_with_fit_settings.initial_params = initial_params
    model_with_fit_settings.param_bounds = bounds
    model_with_fit_settings.vector_input_model = linmods.onepeakplusreps_vectorinput
...
def set_up_model_onepeak_plus_replocs_flat_bg_with_fit_settings():
    ...
    # Generate ModelWithFitSettings object, conatining a model_rpd
    model_with_fit_settings = ModelWithFitSettings(
        model_rpd=linmods.onepeakplusreps_flat_bg
    )
    ...
    initial_params = [
        15.0,  # initial_params_dict['repeat_distance'],
        initial_params_dict["repeat_broadening"],
        initial_params_dict["amp_peak_1"],
        initial_params_dict["loc_prec_sd"],
        initial_params_dict["loc_prec_amp"],
...
def set_up_model_2d_onepeak_plus_replocs_flat_bg_with_fit_settings():
    ...
    # Generate ModelWithFitSettings object, conatining a model_rpd
    model_with_fit_settings = ModelWithFitSettings(
        model_rpd=mods2d.onepeakplusreps_flat_bg
    )
...
def set_up_model_2d_onepeak_plus_replocs_flat_bg_normalised_with_fit_settings():
    ...
    # Generate ModelWithFitSettings object, conatining a model_rpd
    model_with_fit_settings = ModelWithFitSettings(
        model_rpd=mods2d_norm.onepeakplusreps_normalised_flat_bg
    )
...
def set_up_model_2d_twopeaks_flat_bg_normalised_with_fit_settings():
    ...
    # Generate ModelWithFitSettings object, conatining a model_rpd
    model_with_fit_settings = ModelWithFitSettings(
        model_rpd=mods2d_norm.twopeaks_normalised_flat_bg
    )
    ...
    initial_params = [
        initial_params_dict["repeat_distance"],
        initial_params_dict["repeat_distance"] * 2.0,
        initial_params_dict["repeat_broadening"],
        initial_params_dict["amp_peak_1"],
        initial_params_dict["amp_peak_2"],
        initial_params_dict["bg_offset"],
    ...
    upper_bounds = [
        upper_bound_dict["repeat_distance"],
        50.0,  # upper_bound_dict['repeat_distance'],
        upper_bound_dict["repeat_broadening"],
        upper_bound_dict["amp_peak_1"],
        upper_bound_dict["amp_peak_2"],
        upper_bound_dict["bg_offset"],
...
def set_up_model_2d_twopeaks_no_bg_normalised_with_fit_settings():
    ...
    # Generate ModelWithFitSettings object, conatining a model_rpd
    model_with_fit_settings = ModelWithFitSettings(
        model_rpd=mods2d_norm.twopeaks_normalised_no_bg
    )
...
def set_up_model_onepeak_plus_replocs_no_bg_with_fit_settings():
    ...
    # Generate ModelWithFitSettings object, conatining a model_rpd
    model_with_fit_settings = ModelWithFitSettings(
        model_rpd=linmods.onepeakplusreps_no_bg
    )
...
def set_up_model_2d_twopeaks_flat_bg_with_fit_settings():
    ...
    """
    # Generate ModelWithFitSettings object, conatining a model_rpd
    model_with_fit_settings = ModelWithFitSettings(model_rpd=mods2d.twopeaks_flat_bg)
    ...
    model_with_fit_settings.initial_params = initial_params
    model_with_fit_settings.param_bounds = bounds
    model_with_fit_settings.vector_input_model = mods2d.twopeaks_flat_bg_vectorinput

    return model_with_fit_settings


def set_up_model_2d_twopeaks_no_bg_with_fit_settings():
    """Set up the RPD model with fitting settings.
    ...
    """
    # Generate ModelWithFitSettings object, conatining a model_rpd
    model_with_fit_settings = ModelWithFitSettings(model_rpd=mods2d.twopeaks_no_bg)
    ...
    model_with_fit_settings.initial_params = initial_params
    model_with_fit_settings.param_bounds = bounds
    model_with_fit_settings.vector_input_model = mods2d.twopeaks_no_bg_vectorinput

    return model_with_fit_settings


def set_up_model_2d_twopeaks_plusreps_no_bg_with_fit_settings():
    """Set up the RPD model with fitting settings.

    This model has two peaks representing characteristic
    distances.
    Plus repeated localisations.
    No background.
    ...
    # Generate ModelWithFitSettings object, conatining a model_rpd
    model_with_fit_settings = ModelWithFitSettings(
        model_rpd=mods2d.twopeaksplusreps_no_bg
    )
    ...
    model_with_fit_settings.param_bounds = bounds
    model_with_fit_settings.vector_input_model = (
        mods2d.twopeaksplusreps_no_bg_vectorinput
    )

    return model_with_fit_settings


def set_up_model_2d_twopeaks_plusreps_no_bg_normalised_with_fit_settings():
    """Set up the RPD model with fitting settings.
    ...
    # Generate ModelWithFitSettings object, conatining a model_rpd
    model_with_fit_settings = ModelWithFitSettings(
        model_rpd=mods2d_norm.twopeaksplusreps_no_bg_normalised
    )
    ...
    model_with_fit_settings.param_bounds = bounds
    model_with_fit_settings.vector_input_model = (
        mods2d_norm.twopeaksplusreps_no_bg_normalised_vectorinput
    )

    return model_with_fit_settings


def set_up_model_2d_twopeaks_plusreps_flat_bg_with_fit_settings():
    """Set up the RPD model with fitting settings.
    ...
    # Generate ModelWithFitSettings object, conatining a model_rpd
    model_with_fit_settings = ModelWithFitSettings(
        model_rpd=mods2d.twopeaksplusreps_flat_bg
    )
    ...
    model_with_fit_settings.param_bounds = bounds
    model_with_fit_settings.vector_input_model = (
        mods2d.twopeaksplusreps_flat_bg_vectorinput
    )

    return model_with_fit_settings


def set_up_model_2d_twopeaks_plusreps_flat_bg_normalised_with_fit_settings():
    """Set up the RPD model with fitting settings.
    ...
    # Generate ModelWithFitSettings object, conatining a model_rpd
    model_with_fit_settings = ModelWithFitSettings(
        model_rpd=mods2d_norm.twopeaksplusreps_flat_bg_normalised
    )
    ...
    model_with_fit_settings.param_bounds = bounds
    model_with_fit_settings.vector_input_model = (
        mods2d_norm.twopeaksplusreps_flat_bg_normalised_vectorinput
    )

    return model_with_fit_settings


def set_up_model_2d_threepeaks_squarelattice_noreplocs_no_bg_with_fit_settings():
    """Set up the RPD model with fitting settings.

    This model has three peaks representing characteristic
    distances for square lattice.
    No repeated localisations.
    No background.
    ...
    # Generate ModelWithFitSettings object, conatining a model_rpd
    model_with_fit_settings = ModelWithFitSettings(
        model_rpd=mods2d.threepeaks_squarelattice_noreplocs_no_bg
    )
    ...
    model_with_fit_settings.param_bounds = bounds
    model_with_fit_settings.vector_input_model = (
        mods2d.threepeaks_squarelattice_noreplocs_no_bg_vectorinput
    )

    return model_with_fit_settings


def set_up_model_2d_threepeaks_squarelattice_noreplocs_no_bg_normalised_with_fit_settings():
    """Set up the RPD model with fitting settings.
    ...
    # Generate ModelWithFitSettings object, conatining a model_rpd
    model_with_fit_settings = ModelWithFitSettings(
        model_rpd=mods2d_norm.threepeaks_squarelattice_noreplocs_no_bg_normalised
    )
    ...
    model_with_fit_settings.param_bounds = bounds
    model_with_fit_settings.vector_input_model = (
        mods2d_norm.threepeaks_squarelattice_noreplocs_no_bg_normalised_vectorinput
    )
